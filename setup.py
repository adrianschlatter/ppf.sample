...
setup(
    ...
    extras_require={
        'dev': ['check-manifest'],
        'test': ['pytest', 'twine', 'check-manifest', 'readme_renderer',
                 'flake8', 'coverage'],
    },
    ...
    package_data={
        'sampleproject': ['package_data.dat'],
    },
    ...
    data_files=[('sampleproject_data', ['data/data_file'])],

    # To provide executable scripts, use entry points in preference to the
    # "scripts" keyword. Entry points provide cross-platform support and allow
    # pip to create the appropriate form of executable for the target platform.
    entry_points={
        'console_scripts': ['clt=sampleproject.cli:main'],
    },
)
